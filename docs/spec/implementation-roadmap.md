...
- **WS-2.2 — Read + validate `WorkflowSpec`.** Parse spec JSON; validate portable schema conformance, graph integrity (DAG, reachability, single start/end), contract references exist, symbol references exist, and datastore references.
